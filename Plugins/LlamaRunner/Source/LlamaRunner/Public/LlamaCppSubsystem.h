...
struct FLlamaCppSubsystemSamplerConfig
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(ToolTip="WARNING: Greedy will attempt to output the largest response possible, which might not always be ideal!"))
	TEnumAsByte<ELlamaSamplerMethod> SamplerMethod = Dist;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(EditCondition="SamplerMethod!=ELlamaSamplerMethod::Mirostat"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, DisplayName="Use repetition penalty")
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintSetter=SetSamplerConfig)
